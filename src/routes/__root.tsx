    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This portal screen doesn't exist or has been moved.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-lg border border-border-strong px-4 py-2 text-sm font-medium text-foreground"
          >
            Go home
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MellowMoon Receipt Manager" },
      {
        name: "description",
        content:
          "Internal internship and training receipt management portal for MellowMoon SoftTech Pvt. Ltd.",
      },
      { name: "author", content: "MellowMoon SoftTech Pvt. Ltd." },
      { property: "og:title", content: "MellowMoon Receipt Manager" },
      {
